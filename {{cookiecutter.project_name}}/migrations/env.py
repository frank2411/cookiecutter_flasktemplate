...
if "{{cookiecutter.project_name}}" not in api_path:
    raise ValueError("Bad Current working directory")

sys.path.append(api_path)

from {{cookiecutter.project_name}}_api.models import db  # noqa
from {{cookiecutter.project_name}}_api.app import create_app  # noqa
