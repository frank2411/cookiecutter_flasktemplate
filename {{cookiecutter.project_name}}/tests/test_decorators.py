...
from {{cookiecutter.project_name}}_api.decorators import check_bearer_token, authenticate_user
...
class TestAuthorizationDecorators:
    ...
    @patch('{{cookiecutter.project_name}}_api.decorators.request')
    @patch('{{cookiecutter.project_name}}_api.decorators.abort')
...
class TestAuthenticateDecorator:
    ...
    @patch('{{cookiecutter.project_name}}_api.decorators.request')
    @patch('{{cookiecutter.project_name}}_api.decorators.Token.set_current_user')
