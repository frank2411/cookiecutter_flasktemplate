...
class Notify:  # pragma: no cover
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.sender = kwargs.get("sender", current_app.config.get("EMAIL_SENDER_ADDRESS"))
        self.kwargs = kwargs
    ...
    def set_html(self):
        template_name = u"emails/{}.html".format(self.email_template)
        self.html = render_template(template_name, **self.context)

        self.message.add_alternative(self.html, subtype="html")

    def set_text(self):
        template_name = u"emails/{}.txt".format(self.email_template)
